...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240327115217_AddReleaseTicketEntity")]
    partial class AddReleaseTicketEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3931),
                            EndTime = new DateTime(2024, 4, 29, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3923),
                            Introduction = "Join us for a day of learning and networking.",
                            Latitude = "25.0329",
                            Longitude = "121.5654",
                            MemberId = 1,
                            StartTime = new DateTime(2024, 4, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3917),
                            Status = (byte)2,
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3938),
                            EndTime = new DateTime(2024, 5, 30, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3936),
                            Introduction = "Experience the best of local music.",
                            Latitude = "24.1754",
                            Longitude = "120.6899",
                            MemberId = 2,
                            StartTime = new DateTime(2024, 5, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3935),
                            Status = (byte)2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "1234567890",
                            RegisterTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3660),
                            Relationship = (byte)2
                        },
                        new
                        {
                            ...
                            Phone = "0987654321",
                            RegisterTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3680),
                            Relationship = (byte)1
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3987),
                            EndSellTime = new DateTime(2024, 4, 26, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3993),
                            EventId = 1,
                            MaxPurchase = 5,
                            Name = "General Admission",
                            ReleaseAmount = 100,
                            StartSellTime = new DateTime(2024, 3, 28, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3992),
                            Stock = 100,
                            UnitPrice = 50.00m
                        },
                        new
                        {
                            Id = 2,
                            CreateTime = new DateTime(2024, 3, 27, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3996),
                            EndSellTime = new DateTime(2024, 4, 26, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3998),
                            EventId = 1,
                            MaxPurchase = 2,
                            Name = "VIP",
                            ReleaseAmount = 50,
                            StartSellTime = new DateTime(2024, 3, 28, 19, 52, 17, 682, DateTimeKind.Local).AddTicks(3997),
                            Stock = 50,
                            UnitPrice = 100.00m
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.ReleaseTicket", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.OrderDetail", "OrderDetail")
                        ...
                        .HasForeignKey("OrderDetailId")
                        .IsRequired()
                        .HasConstraintName("FK_ReleaseTickets_OrderDetails");

                    b.HasOne("ApplicationCore.Entities.TicketType", "TicketType")
                        .WithMany("ReleaseTickets")
                        .HasForeignKey("TicketTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_ReleaseTickets_TicketTypes");
