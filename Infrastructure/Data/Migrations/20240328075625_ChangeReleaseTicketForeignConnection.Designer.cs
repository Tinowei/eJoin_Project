...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240328075625_ChangeReleaseTicketForeignConnection")]
    partial class ChangeReleaseTicketForeignConnection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8200),
                            EndTime = new DateTime(2024, 4, 30, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8193),
                            Introduction = "Join us for a day of learning and networking.",
                            Latitude = "25.0329",
                            Longitude = "121.5654",
                            MemberId = 1,
                            StartTime = new DateTime(2024, 4, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8187),
                            Status = (byte)2,
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8206),
                            EndTime = new DateTime(2024, 5, 31, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8204),
                            Introduction = "Experience the best of local music.",
                            Latitude = "24.1754",
                            Longitude = "120.6899",
                            MemberId = 2,
                            StartTime = new DateTime(2024, 5, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8203),
                            Status = (byte)2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "1234567890",
                            RegisterTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8022),
                            Relationship = (byte)2
                        },
                        new
                        {
                            ...
                            Phone = "0987654321",
                            RegisterTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8037),
                            Relationship = (byte)1
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8256),
                            EndSellTime = new DateTime(2024, 4, 27, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8261),
                            EventId = 1,
                            MaxPurchase = 5,
                            Name = "General Admission",
                            ReleaseAmount = 100,
                            StartSellTime = new DateTime(2024, 3, 29, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8260),
                            Stock = 100,
                            UnitPrice = 50.00m
                        },
                        new
                        {
                            Id = 2,
                            CreateTime = new DateTime(2024, 3, 28, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8263),
                            EndSellTime = new DateTime(2024, 4, 27, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8265),
                            EventId = 1,
                            MaxPurchase = 2,
                            Name = "VIP",
                            ReleaseAmount = 50,
                            StartSellTime = new DateTime(2024, 3, 29, 15, 56, 25, 574, DateTimeKind.Local).AddTicks(8265),
                            Stock = 50,
                            UnitPrice = 100.00m
                        });
                });
