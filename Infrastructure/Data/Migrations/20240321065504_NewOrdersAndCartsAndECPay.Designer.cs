...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240321065504_NewOrdersAndCartsAndECPay")]
    partial class NewOrdersAndCartsAndECPay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8692),
                            EndTime = new DateTime(2024, 4, 23, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8684),
                            Introduction = "Join us for a day of learning and networking.",
                            Latitude = "25.0329",
                            Longitude = "121.5654",
                            MemberId = 1,
                            StartTime = new DateTime(2024, 4, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8678),
                            Status = (byte)2,
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8696),
                            EndTime = new DateTime(2024, 5, 24, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8695),
                            Introduction = "Experience the best of local music.",
                            Latitude = "24.1754",
                            Longitude = "120.6899",
                            MemberId = 2,
                            StartTime = new DateTime(2024, 5, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8694),
                            Status = (byte)2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "1234567890",
                            RegisterTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8443),
                            Relationship = (byte)2
                        },
                        new
                        {
                            ...
                            Phone = "0987654321",
                            RegisterTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8456),
                            Relationship = (byte)1
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8740),
                            EndSellTime = new DateTime(2024, 4, 20, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8743),
                            EventId = 1,
                            MaxPurchase = 5,
                            Name = "General Admission",
                            ReleaseAmount = 100,
                            StartSellTime = new DateTime(2024, 3, 22, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8743),
                            Stock = 100,
                            UnitPrice = 50.00m
                        },
                        new
                        {
                            Id = 2,
                            CreateTime = new DateTime(2024, 3, 21, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8746),
                            EndSellTime = new DateTime(2024, 4, 20, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8747),
                            EventId = 1,
                            MaxPurchase = 2,
                            Name = "VIP",
                            ReleaseAmount = 50,
                            StartSellTime = new DateTime(2024, 3, 22, 14, 55, 4, 243, DateTimeKind.Local).AddTicks(8746),
                            Stock = 50,
                            UnitPrice = 100.00m
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.CartTicket", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.TicketType", "CartNavigation")
                        .WithMany("CartTickets")
                        .HasForeignKey("CartId")
                        .IsRequired()
                        .HasConstraintName("FK_CartTickets_TicketTypes");
