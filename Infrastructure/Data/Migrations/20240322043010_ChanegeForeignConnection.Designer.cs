...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240322043010_ChanegeForeignConnection")]
    partial class ChanegeForeignConnection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9110),
                            EndTime = new DateTime(2024, 4, 24, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9097),
                            Introduction = "Join us for a day of learning and networking.",
                            Latitude = "25.0329",
                            Longitude = "121.5654",
                            MemberId = 1,
                            StartTime = new DateTime(2024, 4, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9090),
                            Status = (byte)2,
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9114),
                            EndTime = new DateTime(2024, 5, 25, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9113),
                            Introduction = "Experience the best of local music.",
                            Latitude = "24.1754",
                            Longitude = "120.6899",
                            MemberId = 2,
                            StartTime = new DateTime(2024, 5, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9112),
                            Status = (byte)2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "1234567890",
                            RegisterTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(8852),
                            Relationship = (byte)2
                        },
                        new
                        {
                            ...
                            Phone = "0987654321",
                            RegisterTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(8867),
                            Relationship = (byte)1
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9153),
                            EndSellTime = new DateTime(2024, 4, 21, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9157),
                            EventId = 1,
                            MaxPurchase = 5,
                            Name = "General Admission",
                            ReleaseAmount = 100,
                            StartSellTime = new DateTime(2024, 3, 23, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9156),
                            Stock = 100,
                            UnitPrice = 50.00m
                        },
                        new
                        {
                            Id = 2,
                            CreateTime = new DateTime(2024, 3, 22, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9160),
                            EndSellTime = new DateTime(2024, 4, 21, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9161),
                            EventId = 1,
                            MaxPurchase = 2,
                            Name = "VIP",
                            ReleaseAmount = 50,
                            StartSellTime = new DateTime(2024, 3, 23, 12, 30, 10, 292, DateTimeKind.Local).AddTicks(9161),
                            Stock = 50,
                            UnitPrice = 100.00m
                        });
                });
