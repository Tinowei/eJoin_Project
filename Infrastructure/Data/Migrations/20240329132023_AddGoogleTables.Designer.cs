...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20240329132023_AddGoogleTables")]
    partial class AddGoogleTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4442),
                            EndTime = new DateTime(2024, 5, 1, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4435),
                            Introduction = "Join us for a day of learning and networking.",
                            Latitude = "25.0329",
                            Longitude = "121.5654",
                            MemberId = 1,
                            StartTime = new DateTime(2024, 4, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4429),
                            Status = (byte)2,
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4447),
                            EndTime = new DateTime(2024, 6, 1, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4445),
                            Introduction = "Experience the best of local music.",
                            Latitude = "24.1754",
                            Longitude = "120.6899",
                            MemberId = 2,
                            StartTime = new DateTime(2024, 5, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4444),
                            Status = (byte)2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Phone = "1234567890",
                            RegisterTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4221),
                            Relationship = (byte)2
                        },
                        new
                        {
                            ...
                            Phone = "0987654321",
                            RegisterTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4236),
                            Relationship = (byte)1
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.TicketType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4529),
                            EndSellTime = new DateTime(2024, 4, 28, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4534),
                            EventId = 1,
                            MaxPurchase = 5,
                            Name = "General Admission",
                            ReleaseAmount = 100,
                            StartSellTime = new DateTime(2024, 3, 30, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4532),
                            Stock = 100,
                            UnitPrice = 50.00m
                        },
                        new
                        {
                            Id = 2,
                            CreateTime = new DateTime(2024, 3, 29, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4536),
                            EndSellTime = new DateTime(2024, 4, 28, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4538),
                            EventId = 1,
                            MaxPurchase = 2,
                            Name = "VIP",
                            ReleaseAmount = 50,
                            StartSellTime = new DateTime(2024, 3, 30, 21, 20, 23, 579, DateTimeKind.Local).AddTicks(4537),
                            Stock = 50,
                            UnitPrice = 100.00m
                        });
                });
